...
* data_raw/: Contains unprocessed data files, such as growth_measurements.csv and soil_samples.csv.
* data_processed/: Includes cleaned data, e.g., growth_measurements_cleaned.csv after removing outliers and normalizing data.
* documentation/: Holds the project’s documentation, like README.md and any method descriptions, such as measurement_protocol.pdf.
* scripts/: Stores scripts used for data processing and analysis, e.g., data_cleaning.R and analysis_script.R.
